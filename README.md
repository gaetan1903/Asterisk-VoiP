...
Le but de ce projet est de réaliser des appels locals sans frais, juste un réseau commun. 
...
Dans ce petit tutoriel `Si on peut l'appeler comme ça` Nous alons utiliser Debian comme OS.
